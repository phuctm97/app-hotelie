...
Namespace Rooms.Factories
    Public Class CreateRoomCategoryCommand
        Implements ICreateRoomCategoryCommand
        ...
        Public Function Execute(name As String, unitPrice As Decimal) As String Implements ICreateRoomCategoryCommand.Execute
            Try
            ...
            ' initialize room category
                Dim roomCategory = New RoomCategory() With {.Id = newId, .Name = name, .Price= unitPrice}
        ...
        Public Async Function ExecuteAsync(name As String, unitPrice As Decimal) As Task(Of String) Implements ICreateRoomCategoryCommand.ExecuteAsync
            Try
                ' create new room category id
