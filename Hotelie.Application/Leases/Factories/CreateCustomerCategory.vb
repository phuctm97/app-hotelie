...
Namespace Leases.Factories
    Public Class CreateCustomerCategoryFactory
        Implements ICreateCustomerCategoryFactory
        ...
        Public Function Execute(name As String, coefficient As Double) As String _
            Implements ICreateCustomerCategoryFactory.Execute
            Try
        ...
        Public Async Function ExecuteAsync(name As String, coefficient As Double) As Task(Of String) _
            Implements ICreateCustomerCategoryFactory.ExecuteAsync
            Try
                ' create new customer category
