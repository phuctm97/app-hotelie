...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DbUpdate_CustomerCategory_AddCoefficient
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DbUpdate_CustomerCategory_AddCoefficient))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706042000587_DbUpdate_CustomerCategory_AddCoefficient"
            End Get
        End Property
