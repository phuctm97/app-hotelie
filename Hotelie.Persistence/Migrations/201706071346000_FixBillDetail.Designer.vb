...
Namespace Migrations
    ...
    Public NotInheritable Partial Class FixBillDetail
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(FixBillDetail))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201706071346000_FixBillDetail"
            End Get
        End Property
